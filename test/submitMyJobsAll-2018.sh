...
####DATA
python svFitSubmitterFast.py -sd /hdfs/store/user/ojalvo/${jobID}_data_tau_B_tautau-SUB_Data   -iswj=0 -es=0 -mt=-1 -r=2 --jobName ${svfitJobID}
python svFitSubmitterFast.py -sd /hdfs/store/user/ojalvo/${jobID}_data_tau_C_tautau-SUB_Data   -iswj=0 -es=0 -mt=-1 -r=2 --jobName ${svfitJobID}
python svFitSubmitterFast.py -sd /hdfs/store/user/ojalvo/${jobID}_data_tau_D_tautau-SUB_Data   -iswj=0 -es=0 -mt=-1 -r=2 --jobName ${svfitJobID}
python svFitSubmitterFast.py -sd /hdfs/store/user/ojalvo/${jobID}_data_tau_E_tautau-SUB_Data   -iswj=0 -es=0 -mt=-1 -r=2 --jobName ${svfitJobID}
python svFitSubmitterFast.py -sd /hdfs/store/user/ojalvo/${jobID}_data_tau_F_tautau-SUB_Data   -iswj=0 -es=0 -mt=-1 -r=2 --jobName ${svfitJobID}
